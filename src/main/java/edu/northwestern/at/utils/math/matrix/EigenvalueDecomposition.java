 ...
 *
 *	<p>
 *	The is the JAMA code with modifications
 *	for our matrix class.
 *	</p>
 */
...
public class EigenvalueDecomposition
{
	...
	/**	Holds nonsymmetric Hessenberg form.
	 */
		...
		for ( int l = 0 ; l < n ; l++ )
		{
			...
			if ( m > l )
			{
				...
				do
				{
					...
					double r = ArithUtils.hypot(p, 1.0);
	 ...
	 *
	 *	@param	xr	Real part of dividend.
	 *	@param	xi	Imaginary part of dividend.
	 *	@param	yr	Real part of divisor.
	 *	@param	yi	Inmaginary part of divisor.
	 *
	 *	<p>
	 *	The result of the complex division is
	 *	stored in cdivr (real part) and cdivi
	 *	imaginary part.
	 *	</p>
	 */
	 ...
	 *
	 *	@param	matrix	Square matrix for which to compute eigenstructure.
	 */
	 ...
	 *
	 *	@return		double vector of imaginary parts of eigenvalues.
	 */
	 ...
	 *
	 *	@return		n x n block diagonal eigenvalue matrix.
	 */
	...
	public Matrix getD()
	{
		...
		return MatrixFactory.createMatrix( n , n , D );
	}
}
