 ...
 *
 *	<p>
 *	Minor corrections by Philip R. "Pib" Burns, Northwestern University.
 *	</p>
 *	<ul>
 *	<li>Change when "g" format switches to "E" format.</li>
 *	<li>Make ' (thousands grouping) flag work for d and i format.</li>
 *	</ul>
 */
...
public class PrintfFormat
{
	...
	public PrintfFormat(StringBuffer fmtArg)
		throws IllegalArgumentException
	{
		this(Locale.getDefault(), fmtArg.toString());
	}
	...
	public PrintfFormat(Locale locale, StringBuffer fmtArg)
		throws IllegalArgumentException
	{
		this( locale , fmtArg.toString() );
    }
...
//					if (expon >= -4 && expon <= 10 )
		...
		private String printDFormat(long x)
		{
			...
			{
				return printDFormat(
					Formatters.formatLongWithCommas( x ) );
			}
			else
			{
		...
		private String printDFormat(int x)
		{
			...
			{
				return printDFormat(
					Formatters.formatIntegerWithCommas( x ) );
			}
			else
			{
