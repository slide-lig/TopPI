...
public class HadoopCollector extends PatternsCollector {
	...
	public HadoopCollector(Reducer<IntWritable, TransactionWritable, IntWritable, SupportAndTransactionWritable>.Context currentContext) {
		this.context = currentContext;
	}
	
	@Override
	public boolean explore(int[] currentPattern, int extension,
