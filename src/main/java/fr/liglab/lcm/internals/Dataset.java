...
/**
 * a Dataset represents a "smart" transactions database : the object knows the
 * required minimal support count and will gather some statistics and indexes at
 * instantation time, to ease future lattice exploration.
 * 
...
public abstract class Dataset {
	...
	/**
	 * Projects current dataset on the given item, implicitely extending current
	 * pattern
	 * 
	 * Let P be a pattern. If this was P's projection, let Q = P U {i} from
	 * UnoAUA04-Lemma 3 : "extension" is Q's core index
	 * 
	 ...
	 *         in closure's extension
	 */
	public abstract ExtensionsIterator getCandidatesIterator();

	/**
	 * Find (in supportCounts) current dataset's closure (ie. items with 100%
	 * support) By the way, unfrequent items (having a value < minsup) are
	 * removed from supportCounts
	 * 
