...
/**
 * Itemsets and patterns are represented by classic integer arrays Aside static
 * utility methods, instanciate it to create arrays without knowing their length
 * beforehand
 */
