...
public class RebasedConcatenatedDatasetTest {
	...
	public void testNoCrashOnEmpty() {
		...
		Dataset dataset = new RebasedConcatenatedDataset(99999,
	...
	public void testRemapping() {
		// rebasing.dat
		RebasedDataset dataset = new RebasedConcatenatedDataset(2,
		...
		// globalclosure.dat
		dataset = new RebasedConcatenatedDataset(2,
	...
	public void testFileLoading() {
		Dataset dataset = new RebasedConcatenatedDataset(2,
				FileReaderTest.getRebasing());
